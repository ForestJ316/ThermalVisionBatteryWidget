ScriptName TM_ThermalImage_Vision_OF Extends activemagiceffect

;-- Variables ---------------------------------------
Int BatteryCheck = 10

;-- Properties --------------------------------------
ImageSpaceModifier Property TM_Vision_Thermal Auto Const
ImageSpaceModifier Property TM_Vision_Black Auto Const
EffectShader Property TM_TargetFXS_Thermal_Self Auto Const
...
Event OnEffectStart(Actor Target, Actor Caster)
  ...
  If player.IsInPowerArmor()
    If player.GetItemCount(CheatBattery as Form) > 0
      TM_Vision_Thermal.Apply(ThermalStrength)
      TM_TargetFXS_Thermal_Self.Play(player as ObjectReference, -1.0)
...
Event OnEffectFinish(Actor Target, Actor Caster)
  ...
  If player.HasKeyword(TM_Animations_Enabled)
    Utility.Wait(0.5)
    TM_Vision_Thermal.remove()
    TM_TargetFXS_Thermal_Self.Stop(player as ObjectReference)
  Else
    TM_Vision_Thermal.remove()
    TM_TargetFXS_Thermal_Self.Stop(player as ObjectReference)
  EndIf
